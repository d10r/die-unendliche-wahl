// CUSTOM CODE ADDED TO THE BOTTOM OF THIS FILE!

/*!
 * modernizr v3.3.1
 * Build https://modernizr.com/download?-canvas-cryptography-es6collections-localstorage-promises-setclasses-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
function checkBrowserCompatibility() {
    ...
    if (! (m.es6collections && m.promises && m.localstorage && m.canvas && m.crypto)) {
